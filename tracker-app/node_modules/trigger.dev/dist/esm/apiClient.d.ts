import { CreateArtifactRequestBody, CreateBackgroundWorkerRequestBody, DevConfigResponseBody, DevDequeueRequestBody, DevDequeueResponseBody, DevDisconnectRequestBody, DevDisconnectResponseBody, FailDeploymentRequestBody, FailDeploymentResponseBody, FinalizeDeploymentRequestBody, ImportEnvironmentVariablesRequestBody, InitializeDeploymentRequestBody, StartDeploymentIndexingRequestBody, TriggerTaskRequestBody, UpsertBranchRequestBody, WorkersCreateRequestBody, CreateProjectRequestBody, GetJWTRequestBody } from "@trigger.dev/core/v3";
...
export declare class CliApiClient {
    ...
    get dev(): {
        ...
        readonly disconnect: (body: DevDisconnectRequestBody) => Promise<ApiResult<DevDisconnectResponseBody>>;
